...
RcppExport SEXP _qtl2utils_arrange_genes(SEXP startSEXP, SEXP endSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_qtl2utils_arrange_genes", (DL_FUNC) &_qtl2utils_arrange_genes, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_qtl2utils(DllInfo *dll) {
